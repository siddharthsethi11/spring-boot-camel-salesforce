...
public class DataSet extends BaseModel {
    ...
    public TablePermission getTablePermission() {
        if (containsField("tablePermission")) {
            Object tablePermission = get("tablePermission");
            if (Map.class.isAssignableFrom(tablePermission.getClass())) {
                return new TablePermission((Map) tablePermission);
            }
        }
    ...
    public void setTablePermission(TablePermission tablePermission) {
        if (tablePermission != null) {
            put("tablePermission", tablePermission);
        }
    }
